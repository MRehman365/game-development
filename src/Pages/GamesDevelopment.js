...
const GamesDevelopment = () => {
  ...
  const settings = {
    ...
    autoplay: false,
    autoplaySpeed: 2000,
    appendDots: (dots) => <ul className="slick-dots slick-thumb" style={{ marginbottom: "-50px",}}>{dots}</ul>, // Add this line
  };
    ...
    <div className="background-rays">
      ...
      <div className="flex flex-wrap justify-center sm:p-0 md:p-8">
        {games.map((game, index) => (
          <div key={game.id} className="w-full md:w-1/2 lg:w-1/3 p-4 game-card-container">
            <div
            ...
            >
              <div className="relative top-[-40px] pb-10"> {/* Add pb-10 for padding-bottom */}
